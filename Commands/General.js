...
zokou({ nomCom: "dev", categorie: "General", reaction: "💞" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "LUKAS 😎", numero: "+255 614 042 524" },
      { nom: "KING 👑", numero: "+255 614 042 524" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋🤓 ʰᵉˡˡᵒ Welcome🤝 To LUKA'S MD here is the dev :\n\n";
...
zokou({ nomCom: "developer", categorie: "General", reaction: "❣️" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "lukas", numero: "+255 614 042 524" },
      { nom: "king lukas", numero: "+255 614 042 524" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Welcome to LUKAS MD* here is the developer numbers:\n\n";
    for (const dev of devs) {
      message += `----------------\n• ${dev.nom} : https://wa.me/${dev.numero}\n`;
    }
  var lien = mybotpic()
