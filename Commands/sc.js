...
*GITHUB LINK*
> https://github.com/bmbttz

*YouTube channel*
https://youtube.com/@yessertech?si=mkU9LFHXIGXy1Gbv

*FOR DEVELOPER T.ME*
> https://wa.me/+255 614 042 524
*WHATSAPP CHANNEL*
>  https://whatsapp.com/channel/0029VakA1mu35fM18opH1s30

*FOR MORE INFO TAP ON THE LINK BELOW*
> https://github.com/bmbttz/LUKAS-MD
╭──━━━━═════════━━━━⦿
┃ ❂━━━════➳════━━━━❂
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "I am *LUKA MD V7*, Developed By Fredie Sir" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
